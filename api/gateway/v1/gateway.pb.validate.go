...
// Validate checks the field values on VisitURLRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *VisitURLRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on VisitURLRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// VisitURLRequestMultiError, or nil if none found.
func (m *VisitURLRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *VisitURLRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return VisitURLRequestMultiError(errors)
	}

	return nil
}

// VisitURLRequestMultiError is an error wrapping multiple validation errors
// returned by VisitURLRequest.ValidateAll() if the designated constraints
// aren't met.
type VisitURLRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m VisitURLRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m VisitURLRequestMultiError) AllErrors() []error { return m }

// VisitURLRequestValidationError is the validation error returned by
// VisitURLRequest.Validate if the designated constraints aren't met.
type VisitURLRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e VisitURLRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VisitURLRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VisitURLRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VisitURLRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VisitURLRequestValidationError) ErrorName() string { return "VisitURLRequestValidationError" }

// Error satisfies the builtin error interface
func (e VisitURLRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sVisitURLRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = VisitURLRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = VisitURLRequestValidationError{}

// Validate checks the field values on VisitURLReply with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *VisitURLReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on VisitURLReply with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in VisitURLReplyMultiError, or
// nil if none found.
func (m *VisitURLReply) ValidateAll() error {
	return m.validate(true)
}

func (m *VisitURLReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return VisitURLReplyMultiError(errors)
	}

	return nil
}

// VisitURLReplyMultiError is an error wrapping multiple validation errors
// returned by VisitURLReply.ValidateAll() if the designated constraints
// aren't met.
type VisitURLReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m VisitURLReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m VisitURLReplyMultiError) AllErrors() []error { return m }

// VisitURLReplyValidationError is the validation error returned by
// VisitURLReply.Validate if the designated constraints aren't met.
type VisitURLReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e VisitURLReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e VisitURLReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e VisitURLReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e VisitURLReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e VisitURLReplyValidationError) ErrorName() string { return "VisitURLReplyValidationError" }

// Error satisfies the builtin error interface
func (e VisitURLReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = VisitURLReplyValidationError{}
...
func (m *DecodeURLRequest) validate(all bool) error {
	...
	if utf8.RuneCountInString(m.GetCode()) < 5 {
		err := DecodeURLRequestValidationError{
			field:  "Code",
