...
func NewGRPCServer(c *conf.Server, tp *tracesdk.TracerProvider, serv *service.GatewayService, logger log.Logger) *grpc.Server {
	...
	v1.RegisterGatewayServer(srv, serv)
	return srv
}
